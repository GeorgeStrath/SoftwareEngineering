        ...
        <div class="xop-right">
            ...
            <div class=loginbox>
               ...
               <?php echo validation_errors();?>
                    ...
                    <form action="<?php echo base_url();?>homecnt/employerdash" method="POST" enctype="multipart/form-data">
                                <p>Full name</p>
                                ...
                                <p>Phone number</p>
                                <input type="number" name="pnum" id="pnum" placeholder="Enter your phone number" required><br>
                                <p>Password</p>
                                ...
                                <p>What type of employer are you</p>
                                <select class="form-control" name="typeofemployer" required>
